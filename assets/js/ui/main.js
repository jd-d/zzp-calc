import { initializeCalculatorUI } from './calculator.js';
...
function setBodyScrollLock(source, locked) {
  const locks = setBodyScrollLock.locks || new Map();
  setBodyScrollLock.locks = locks;
  ...
  document.documentElement.classList.toggle('scroll-locked', locks.size > 0);
}
